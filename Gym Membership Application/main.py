...
x = 100
while x != "0":
    x = input("Press 1 for super_user \nPress 2 for Member \nPress 0 for Exit \n--")
    choose_option = 100
    if x == "1":
        ...
        while choose_option != "0":
            choose_option = input("Press 1 for create Member \nPress 2 for view Member "
                                  ...
                                  "Press 0 for Exit from Owner Group\n--")
            if choose_option == "1":
                Member.Add_Member()
                ...
                if process == "0":
                    input1 = input("What you want to update- Name, Age, Gender, Email, BMI, Month-\n--"
                                   "**mobile number would not to changed***[case sensitive]\n--")
                ...
                if Input3 in Regimen_for_All_Member:
                    ...
                    print("Please First Add Regiment then Update(Regimen deleted by you)")
        ...
        while choose_option != "0":
            choose_option = input("Press 1 for My RegimenPress \nPress 2 for My Profile "
